...
public class Main2Activity extends AppCompatActivity implements TestContract.LoginView,View.OnClickListener{
    ...
    public void setUsernameError() {
            user.setError("Contract!!!!!setUsernameError");
    }

    @Override
    public void setPasswordError() {
        password.setError("Contract!!!!!setPasswordError");
    }
